...
- The launcher stores the capability in owner-readable mode-`600` files, opens a short-lived bootstrap page, passes the capability in a URL fragment, and then the interface clears that fragment from browser history.
